...
const JavaScriptVariables = () => {
    ...
    <div className="space-y-5 md:space-y-8">
      <div className="space-y-3" id='what-are-variables'>
        <h2 className="text-3xl font-bold md:text-3xl dark:text-pink-700 text-violet-400 py-4">What are Variables?</h2>
      </div>

      <p className="text-lg text-gray-800 dark:text-gray-200">A variable is a storage location or a memory location that holds a data type and values. JavaScript variables are variables declared and assigned in JavaScript, following the JavaScript syntax, that holds values and datatypes.
        <br /><br />In this article, we will look at variables in JavaScript, the datatypes they hold, good naming and writing practices, how they are implemented and manipulated and their scope.</p>

      <h2 className="text-3xl font-bold md:text-3xl  dark:text-pink-700 text-violet-400 py-4" id='variable-declaration'>JavaScript variable declaration, Initializing and Assigning Variables</h2>
      <p className="text-md text-gray-800 dark:text-gray-200">In this article, we will look at how to declare and initialize variables in JavaScript.</p>
      <p className="text-md text-gray-800 dark:text-gray-200">A variable is declared when it is created. In JavaScript, variables are declared using any of these three keywords - var, let and const.</p>
      <div className="mockup-code w-full object-cover rounded-xl">
        <pre data-prefix="1"><code>var x= 2</code></pre> 
        <pre data-prefix="2" className="text-warning"><code>let y=2</code></pre> 
        <pre data-prefix="3" className="text-success"><code>const z=2</code></pre>
      </div>
      <div className="text-sm text-center text-gray-500" id='types-of-variables'>
          Types of variable declarations in JavaScript
      </div>
      <p className="text-lg text-gray-800 dark:text-gray-200">The above code snippet shows us the different ways of declaring a variable in JavaScript. We can declare a variable using var, let or const. We can also initialize a variable using the assignment operator (=).</p>
